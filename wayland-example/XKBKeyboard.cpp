...
void XKBKeyboard::use_keymap_fd(int fd, uint32_t size)
{
...
void XKBKeyboard::update_modifiers(uint32_t mods_depressed, uint32_t mods_latched, uint32_t mods_locked, uint32_t group)
{
