...
void WaylandDisplay::add_window(WaylandWindow* window)
{
	windows.push_back(window);
}

void WaylandDisplay::remove_window(WaylandWindow* window)
{
...
WaylandWindow* WaylandDisplay::window_for(struct wl_surface* wayland_surface)
{
	for (auto window: windows) {
