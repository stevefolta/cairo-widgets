...
class WaylandDisplay {
	public:
		...
		void add_window(WaylandWindow* window);
	...
	protected:
		std::list<WaylandWindow*> windows;
		WaylandWindow* pointer_window = nullptr;
		WaylandWindow* key_window = nullptr;
		...
		WaylandWindow* window_for(struct wl_surface* wayland_surface);
